...
**Current sequencing update — 2026-09-02:** The active [S0 closure plan](s0-observability-closure-plan-2026-08-25.md) restricts current work to S0 instrumentation. S0.3.4 representative small/medium compute and S0.3.5 scoped Reader acceptance are recorded. S0.3.6 [small](../reviews/s0-3-6-failure-retry-small-acceptance-2026-09-02.md) and [medium](../reviews/s0-3-6-failure-retry-medium-acceptance-2026-09-02.md) now pass for single-scope and sequential two-scope success paths on exact Staging `7435aa3fa7ba0766d8cc2584bcacfd735c5ce74c`; real nonzero retries and concurrent runtime execution are not claimed. Four required metrics remain uninstrumented. Follow the [current action order](s0-observability-closure-plan-2026-08-25.md#61-next-decisions-and-remaining-instrumentation), with S0.3.1 upload-owned memory scope design next. No further PDF run is requested for the accepted S0.3.6 target. S0 remains In Progress, and S1/S2 are not started. This current sequencing replaces the immediate S0-plus-S1 recommendation below, while retaining the later architecture phases and their scope. It authorizes no new fixture run, runtime implementation, PR merge or deployment.
