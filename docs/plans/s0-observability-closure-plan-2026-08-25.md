...
6. **Next executable work:** complete the remaining S0.3.7 contract review and source-pinned TXT lifecycle/timing inspection. The [attribution decision record](s0-remaining-attribution-decisions-2026-09-11.md) keeps full upload memory and preprocessing CPU unimplemented until a complete method or explicit scope decision exists. Neither more fixtures nor auxiliary-metric renaming resolves these gaps.
